                    ...
                    <div className="mt-5 space-y-5">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <p className="font-black text-slate-900">{photos.length} of 7 saved</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        {photos.map((photo) => (
                            <article key={photo.id} className="group overflow-hidden rounded-2xl border border-slate-200 bg-white">
                                <button type="button" onClick={() => setLightboxPhoto(photo)} className="block aspect-[4/3] w-full overflow-hidden bg-slate-100">
                                    <img src={photoUrls[photo.id]} alt={photo.title || 'Historical choir memory'} className="h-full w-full object-cover transition duration-300 group-hover:scale-105" />
                                </button>
                                <div className="p-4">
