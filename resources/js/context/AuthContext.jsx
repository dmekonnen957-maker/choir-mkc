...
export function AuthProvider({ children }) {
    ...
    const can = useCallback((permission) => {
        ...
        const aliases = {
            ...
            'users.update': ['users.edit', 'users.manage'],
            'users.edit': ['users.update', 'users.manage'],
            'users.create': ['users.manage'],
            'users.delete': ['users.manage'],
            'users.view': ['users.view.all', 'users.manage'],
            'users.approve': ['users.manage'],
            'roles.update': ['roles.edit', 'roles.manage'],
            'roles.edit': ['roles.update', 'roles.manage'],
            'roles.create': ['roles.manage'],
            'roles.delete': ['roles.manage'],
            'roles.view': ['roles.manage'],
            'permissions.update': ['permissions.edit', 'permissions.manage'],
            'permissions.edit': ['permissions.update', 'permissions.manage'],
            'permissions.create': ['permissions.manage'],
            'permissions.delete': ['permissions.manage'],
            'permissions.view': ['permissions.manage'],
            'choirs.update': ['choirs.edit', 'choirs.manage'],
            'choirs.edit': ['choirs.update', 'choirs.manage'],
            'choirs.create': ['choirs.manage'],
            'choirs.delete': ['choirs.manage'],
            'choirs.view': ['choirs.view.all', 'choirs.manage'],
            'attendance.update': ['attendance.edit', 'attendance.manage'],
            'attendance.edit': ['attendance.update', 'attendance.manage'],
            'attendance.create': ['attendance.manage'],
            'attendance.delete': ['attendance.manage'],
            'attendance.view': ['attendance.manage'],
            'announcements.update': ['announcements.edit', 'announcements.manage'],
            'announcements.edit': ['announcements.update', 'announcements.manage'],
            ...
            'gallery.update': ['gallery.edit', 'gallery.manage'],
            'gallery.edit': ['gallery.update', 'gallery.manage'],
            'gallery.create': ['gallery.manage'],
            'gallery.delete': ['gallery.manage'],
            'gallery.view': ['gallery.view.all', 'gallery.manage'],
            'calendar.update': ['calendar.edit', 'calendar.manage'],
            'calendar.edit': ['calendar.update', 'calendar.manage'],
            'calendar.create': ['calendar.manage'],
            'calendar.delete': ['calendar.manage'],
